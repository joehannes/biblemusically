...
export const api = {
  ...
  subsSignOut: () => invokeCommand("subs_sign_out"),
  subsPricing: () => invokeCommand("subs_pricing"),
  subsTerms: () => invokeCommand("subs_terms"),
  ...
  endSession: (device) => invokeCommand("end_session", { device }),
  endOtherSessions: () => invokeCommand("end_other_sessions"),
  sendReport: (payload) => invokeCommand("send_report", { payload }),
  trackEvents: (payload) => invokeCommand("track_events", { payload }),
  // ============ Updates ============
