...
#[path = "../kaggle_api.rs"]
pub mod kaggle_api;
#[path = "../kaggle_accounts.rs"]
pub mod kaggle_accounts;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::kaggle_account_overview,
            commands::pick_kaggle_account,
            ...
            commands::fal_catalogue,
            commands::test_fal,
            commands::fal_generate,
            ...
            commands::universe_axes,
            commands::universe_interview_next,
            commands::universe_save,
            commands::universe_list,
            commands::universe_delete,
            commands::universe_derive,
            commands::universe_retell,
            commands::book_matter_kinds,
            commands::volume_save,
            commands::volume_list,
            commands::volume_delete,
            commands::volume_autofill,
            ...
            commands::store_flavours,
            commands::store_profile,
            commands::save_store_profile,
            commands::store_price,
